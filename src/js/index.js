...
function render(variables = {}) {
  ...
  if (variables.linkedin === null)
    variables.linkedin = "showcase/4geeks-academy-latam/";
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class="${variables.socialMediaPosition}">
            ...
            <li><a href="hhttps://www.linkedin.com/${variables.linkedin}"><i class="fa fa-linkedin"></i></a></li>
            <li><a href="https://www.instagram.com/4geeksacademycl/${variables.instagram}"><i class="fa fa-instagram"></i></a></li>
          </ul>
        </div>
    `;
}
